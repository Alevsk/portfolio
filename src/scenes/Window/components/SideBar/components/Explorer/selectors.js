...
export const getSectionOpenEditors = (state) => state.Window.sideBar.explorer.data.sectionOpenEditors;

export const getSectionOpenFileExplore = (state) => state.Window.sideBar.explorer.data.sectionOpenFileExplorer;
